...
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-power -e"), { description = "Logout" })
...
-- Aktives Fenster manuell nach special:games senden
hl.bind(mainMod .. " + SHIFT + G", hl.dsp.window.move({ workspace = "special:games" }))
-- Aktives Fenster aus special:games zurück auf aktuellen regulären Workspace
hl.bind(mainMod .. " + SHIFT + ALT + G", hl.dsp.window.move({ workspace = "e+0" }))
